...
if not exist "C:\Windows\Temp\VBoxGuestAdditions.iso" (
    powershell -Command "(New-Object System.Net.WebClient).DownloadFile('http://download.virtualbox.org/virtualbox/5.1.18/VBoxGuestAdditions_5.1.18.iso', 'C:\Windows\Temp\VBoxGuestAdditions.iso')" <NUL
)
